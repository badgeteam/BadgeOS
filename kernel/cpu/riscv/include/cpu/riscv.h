...
#define RV_MSTATUS_SIE_BIT      1
#define RV_MSTATUS_MIE_BIT      3
#define RV_MSTATUS_SPIE_BIT     5
#define RV_MSTATUS_UBE_BIT      6
#define RV_MSTATUS_MPIE_BIT     7
#define RV_MSTATUS_SPP_BIT      8
#define RV_MSTATUS_VS_BASE_BIT  9  // ,10
#define RV_MSTATUS_MPP_BASE_BIT 11 // ,12
#define RV_MSTATUS_FS_BASE_BIT  13 // ,14
#define RV_MSTATUS_XS_BASE_BIT  15 // ,16
#define RV_MSTATUS_MPRV_BIT     17
#define RV_MSTATUS_SUM_BIT      18
#define RV_MSTATUS_MXR_BIT      19
#define RV_MSTATUS_TVM_BIT      20
#define RV_MSTATUS_TW_BIT       21
#define RV_MSTATUS_TSR_BIT      22
#define RV_MSTATUS_SR_BIT       31
